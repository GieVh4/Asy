...
class LINE:
  ...
  def __init__(self):
    ...
    self._headers = {'X-Line-Application': 'DESKTOPMAC	8.3.2	HELLO-WORLD	12.1.1', 'X-Line-Access': 'Emp1jl3qOjxCjXEhmaN5.QdLXoVPaKOU6WpvD80Sijq.NcwnmLOaI/dIyi3Y84WTCOxbNTN27m3ODDpkMLDPY64=', 'User-Agent': 'Line/2018.07421.2455.Tanduri/760.1.6 WIN10/18.2.1'}
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {
              'X-Line-Application': 'DESKTOPMAC	8.3.2	HELLO-WORLD	12.1.1', 
              'X-Line-Access': self.authToken, 
              'User-Agent': 'Line/2018.07421.2455.Tanduri/760.1.6 WIN10/18.2.1'
   }
